...
__packages_dir__ = ["", 'appData', 'core', 'plug_ins', 'preSetup', 'tankers', 'tools', 'ui', 'utilities']
...
__modules__ = ["PLM", "appData/scr/_docs", "appData/config", "appData/ServerCfg", "appData/__init__",

               "core/Attributes", "core/Configurations", "core/Cores", "core/Errors", "core/EventHandler", "core/keys",
               "core/Loggers", "core/Metadata", "core/paths", "core/Settings", "core/SQLS", "core/Storage",
               "core/StyleSheets", "core/vlogging",

               "plg_ins/pyqt5_style_rc", "plg_ins/Qt", "plg_ins/tooltips_rc",

               "ui/AppToolbar/DockToolBar", "ui/AppToolbar/MainToolBar",

               "ui/Funcs/ForgotPassword", "ui/Funcs/SignIn", "ui/Funcs/SignUp",

               "ui/Info/About", "ui/Info/CodeConduct", "ui/Info/Contributing", "ui/Info/Credit", "ui/Info/LicenceMIT", "ui/Info/Reference", "ui/Info/Version",

               "ui/Menus/config/config_rc", "ui/Menus/config/Configuration", "ui/Menus/config/Preferences",

               "ui/Menus/MainMenuBar", "ui/Menus/SubMenuBar",

               "ui/Network/ServerMonitor", "ui/Network/ServerStatus", "ui/Network/connector/mainwindow", "ui/Network/connector/resources",
               "ui/Network/connector/server",

               "ui/NodeGraph/MenuBar",  "ui/NodeGraph/Node",  "ui/NodeGraph/NodeGraph", "ui/NodeGraph/Scene",  "ui/NodeGraph/View",

               "ui/Projects/NewProject",

               "ui/Settings/SettingUI", "ui/Settings/UserSetting",

               "ui/Tools/TextEditor/TextEditor", "ui/Tools/TextEditor/TextEditor_rc", "ui/Tools/Calculator", "ui/Tools/Calendar",
               "ui/Tools/EnglishDictionary", "ui/Tools/FindFiles", "ui/Tools/ImageViewer", "ui/Tools/NoteReminder", "ui/Tools/Screenshot",

               "ui/uikits/Action", "ui/uikits/Button", "ui/uikits/DockWidget", "ui/uikits/GridLayout",
               "ui/uikits/GroupBox", "ui/uikits/node_widgets", "ui/uikits/TabWidget", "ui/uikits/ToolBar",
               "ui/uikits/UiPreset", "ui/uikits/Widget",

               "ui/Web/PLMBrowser", "ui/Web/PLMBrowser_rc",

               "ui/BotTab", "ui/Debugger", "ui/Footer", "ui/GeneralSetting", "ui/PipelineManager", "ui/StatusBar", "ui/SysTrayIcon",
               "ui/TopTab", "ui/TopTab1", "ui/TopTab2", "ui/TopTab3", "ui/TopTab4", "ui/TopTab5", "utilities/localSQL", "utilities/utils", "utilities/Worker",]
