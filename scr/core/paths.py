...
# PLM
from scr.core.Metadata import __appname__, __groupname__, __envKey__
...
if os.path.exists(cfgFile):
    ...
    CONFIG_LOCAL_DAMG_DIR = cfgPths['root']
    CONFIG_LOCAL_PLM_DIR = cfgPths['config']
    CONFIG_DIR = cfgPths['config']
else:
    CONFIG_LOCAL_DAMG_DIR   = os.path.join(LOCALAPPDATA, __groupname__)                 # DAMG team directory
...
from scr.appData.scr._docs import PLM_ABOUT
