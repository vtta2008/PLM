...
from scr.core.Metadata import __groupname__, __appname__, __plmWiki__, __pkgsReq__
from scr.core.keys import autodeskVer, KEYDETECT, KEYPACKAGE, CONFIG_APPUI, CONFIG_SYSTRAY, FIX_KEY
from scr.core.paths import PLM_LOGO_32, DAMG_LOGO_32, ICON_DIR_32, PROGRAM64, PROGRAM86, LOCALAPPDATA, PROGRAMDATA
    ...
    def cfg_localDB(self):
        if self._pthInfo:
            ...
            if not os.path.exists(self.pthInfo['localDB']):
                from scr.core.SQLS import SQLS
