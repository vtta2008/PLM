...
from scr.core.Storage import PObj
from scr.core.Metadata import __organization__, __appname__, __version__, __website__
...
class AppCores(PObj):
    ...
    def __init__(self, settings, parent=None):
        ...
        from scr.ui.Settings.SettingUI import SettingUI
    ...
    def import_uiSet1(self):
        ...
        from scr.ui import PipelineManager, SysTrayIcon
        from scr.ui.Funcs import SignUp, SignIn, ForgotPassword
    ...
    def import_uiSet2(self):
        ...
        from scr.ui.Settings import UserSetting
        from scr.ui.Projects import NewProject
        from scr.ui.Info import Credit, About, CodeConduct, Contributing, Reference, Version, LicenceMIT
        from scr.ui.Tools import Screenshot, NoteReminder, ImageViewer, FindFiles, EnglishDictionary, Calendar, Calculator
        from scr.ui.Menus.config import Preferences, Configuration
        from scr.ui.Tools.TextEditor import TextEditor
        from scr.ui.NodeGraph import NodeGraph
