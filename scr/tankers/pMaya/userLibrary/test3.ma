...
//Name: test3.ma
//Last modified: Sun, May 14, 2017 07:47:54 AM
//Codeset: 1252
...
fileInfo "vrayBuild" "3.52.01 4b97004";
createNode transform -s -n "persp";
	rename -uid "41AB5951-4195-F1BB-5262-39ACC1629B3B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.203304169180015 2.4024781268849851 3.2033041691799893 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -5.172681101354183e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "7AE4E904-4E66-EFBD-6CE7-07B7B64528B7";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 5.1277886413865286;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "029C978A-420D-A1D4-0DD1-6EAE273B696A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "68293196-419B-AED9-E63C-DAAFE7B9D35E";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "92B9A311-4D26-7CB1-9162-168AF3730E79";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "3F80DDCB-4633-B543-3910-C6AEDB220D88";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "D1E41F76-4BAD-1464-17DC-8B9C1B296B02";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "8E54FB30-4AA5-10AF-2BA8-57A1B0586E2B";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "Spike_Cross_Control";
	rename -uid "08217460-41C1-B281-7394-8C83D4B77C95";
createNode nurbsCurve -n "Spike_Cross_ControlShape" -p "Spike_Cross_Control";
	rename -uid "66D7B003-4C34-1D73-C8E7-C09771CEBA68";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovc" 15;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BCBE0D7D-43ED-A4EC-616D-A58E45380549";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A7C4F0AD-46FB-591A-1A66-F7881B87A6FB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "9C6436EB-4C9E-683F-79C6-66975688E71A";
createNode displayLayerManager -n "layerManager";
	rename -uid "B95DD8B4-4D29-86E5-896D-5C8AB1E5276E";
createNode displayLayer -n "defaultLayer";
	rename -uid "28E1AF69-4E1F-2863-1B05-CA8D406214E6";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5C0181AB-40B5-034A-00E1-6DB685A489D4";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "CF2012F5-42FF-D150-9852-D683FF0B8AB2";
	setAttr ".g" yes;
createNode RenderMan -s -n "renderManRISGlobals";
	rename -uid "5704A2EC-4FA2-6F03-24D4-70B03AD3D663";
...
createNode OmnidirectionalStereo -s -n "OmnidirectionalStereo";
	rename -uid "814AC839-46BC-79B7-299E-369EB0FC6850";
lockNode -l 1 ;
createNode PxrCamera -s -n "PxrCamera";
	rename -uid "AB3776FE-4AD9-A7C0-35C8-D8B9E8C52D3F";
lockNode -l 1 ;
createNode PxrDebugShadingContext -s -n "PxrDebugShadingContext";
	rename -uid "FDAAFF15-4967-2249-70BE-A8BD764875CB";
lockNode -l 1 ;
createNode PxrDefault -s -n "PxrDefault";
	rename -uid "512AFDC5-4DAE-0876-0AE7-7498A948B2CB";
lockNode -l 1 ;
createNode PxrDirectLighting -s -n "PxrDirectLighting";
	rename -uid "7BE8AC2E-4813-77EB-0467-60BA8C4945D5";
lockNode -l 1 ;
createNode PxrOcclusion -s -n "PxrOcclusion";
	rename -uid "E1BF00FD-4685-60E8-0268-D6B3428DEBE7";
lockNode -l 1 ;
createNode PxrPathTracer -s -n "PxrPathTracer";
	rename -uid "A61B5FAE-4B8E-48E7-DDF2-57B9A769DC58";
lockNode -l 1 ;
createNode PxrVCM -s -n "PxrVCM";
	rename -uid "5C7B59E6-4FF7-098D-35B8-CAA664CA28BA";
lockNode -l 1 ;
createNode PxrValidateBxdf -s -n "PxrValidateBxdf";
	rename -uid "C16727EA-4EA0-C018-DE25-059C33C3EF49";
lockNode -l 1 ;
createNode PxrVisualizer -s -n "PxrVisualizer";
	rename -uid "3EAAF49E-4765-6344-D22B-48A09B69DFA4";
lockNode -l 1 ;
createNode partition -n "mtorPartition";
	rename -uid "8ACA3DB6-4ED6-66C6-A0A8-C791EE9A24D1";
...
createNode script -n "uiConfigurationScriptNode";
	rename -uid "CD33D265-4067-93CC-7A95-3AA94B32D366";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "3023FDCB-47D8-6984-C209-159A00DCF93F";
