...
from toolkits.Widgets               import Widget, GridLayout, Label, Button, LineEdit, MessageBox, GroupGrid, GroupBox
...
class UserSetting(Widget):
    ...
    def buildUI(self):
        ...
        self.avatar_section = Avatar(self)
        ...
        self.layout.addWidget(self.avatar_section, 0, 0, 1, 1)
    ...
    #
    #     self.avatar = Label()
    #     self.avatar.setPixmap(Pixmap.fromImage(Image(get_avatar_image(self.username))))
    ...
    #     fileName, _ = QFileDialog.getOpenFileName(self, "Your Avatar", imgsDir, "All Files (*);;Img Files (*.jpg)", options=options)
    #
    #     if fileName:
    ...
    #             image = Pixmap.fromImage(Image(desPth))
