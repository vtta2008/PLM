...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QPushButton, QPlainTextEdit, QDesktopWidget, QApplication
...
class name_highlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None, user_name=None, host_name=None, cwd=None):
        super(name_highlighter, self).__init__(parent)
...
class PythonThread(QThread):
    ...
    def __init__(self):
        super(PythonThread, self).__init__()
...
# -------------------------------------------------------------------------------------------------------------
# Created by panda on 6/11/2019 - 1:23 AM
