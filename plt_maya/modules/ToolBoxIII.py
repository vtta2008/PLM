...
from plt_maya.plugins.Qt.QtWidgets import *
from plt_maya.plugins.Qt.QtGui import *
from plt_maya.plugins.Qt.QtCore import *
...
class toolBoxIII(QtWidgets.QWidget):
    ...
    def buildUI(self):
        ...
        self.iconBtnLayout.addWidget(QtWidgets.QLabel("plt_maya: "))
