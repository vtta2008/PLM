...
# PLM
from dCore       import __envKey__, __pkgsReq__
from dCore       import LOGO_DIR, WEB_ICON_DIR, TAG_DIR, AVATAR_DIR
from dCore       import KEYPACKAGE
from dCore       import IsADirectoryError, FileNotFoundError
