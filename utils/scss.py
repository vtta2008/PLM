...
# Local imports
from appData import (MAIN_SCSS_PTH, VAR_SCSS_PTH, QSS_PATH, STYLE_RC_DIR,  DarkPalette, HEADER_SCSS,
                     HEADER_QSS, PY2)
from .images import create_images, create_palette_image
...
def create_qss(qss_filepath=QSS_PATH, main_scss_filepath=MAIN_SCSS_PTH,
               variables_scss_filepath=VAR_SCSS_PTH,
               palette=DarkPalette):
...
def create_custom_qss(
    ...
    rc_loc = os.path.basename(STYLE_RC_DIR)
    ...
    shutil.copytree(STYLE_RC_DIR, theme_rc_path)
    ...
    # Compile SCSS
    variables_scss_filepath = os.path.join(theme_qss_path, '_variables.scss')
    theme_main_scss_filepath = os.path.join(theme_qss_path, 'main.scss')
    theme_qss_filepath = os.path.join(theme_root_path, 'style.qss')
