...
# PLM
from dCore.Loggers import Loggers
from dAssets import __organizscration__, __appname__, __version__, __website__
...
class AppCores(DObj):
    ...
    def __init__(self, settings, parent=None):
        ...
        from dAssets.PLM.Settings.SettingUI import SettingUI
    ...
    def import_uiSet1(self):
        ...
        from dAssets.PLM import PipelineManager, SysTrayIcon
        from dAssets.PLM.Funcs import SignUp, SignIn, ForgotPassword
    ...
    def import_uiSet2(self):
        ...
        from dAssets.PLM.Settings import UserSetting
        from dAssets.PLM.Projects import NewProject
        from dAssets.PLM.Info import Credit, About, CodeConduct, Contributing, Reference, Version, LicenceMIT
        from dAssets.PLM.Tools import Screenshot, NoteReminder, ImageViewer, FindFiles, EnglishDictionary, Calendar, Calculator
        from dAssets.PLM.Menus.config import Preferences, Configuration
        from dAssets.PLM.Funcs.Tools.TextEditor import TextEditor
        from dAssets.PLM.NodeGraph import NodeGraph
