...
from PyQt5.QtCore import QRegExp, Qt, QByteArray, QDateTime, QDate, QTime, QPoint, QRect, QSize
from PyQt5.QtWidgets import QItemDelegate, QStyleOptionViewItem, QStyle, QLineEdit
...
class VariantDelegate(QItemDelegate):
    ...
    def isSupportedType(value):
        return isinstance(value, (bool, float, int, QByteArray, str, QColor, QDate, QDateTime, QTime, QPoint, QRect, QSize, list))
...
# -------------------------------------------------------------------------------------------------------------
# Created by panda on 11/07/2018 - 9:47 AM
