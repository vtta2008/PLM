...
import options
from ui.commands import SceneNodesCommand, SceneChangedCommand

class NodeWidget(QtWidgets.QGraphicsObject):

    Type           = QtWidgets.QGraphicsObject.UserType + 1
    ...
    def __init__(self, dagnode, parent=None):
        ...
        self.setFlag(QtWidgets.QGraphicsObject.ItemSendsGeometryChanges, True)
        self.setFlag(QtWidgets.QGraphicsObject.ItemSendsScenePositionChanges, True)
...
class EdgeWidget(QtWidgets.QGraphicsObject):
    
    Type          = QtWidgets.QGraphicsObject.UserType + 2
    adjustment    = 5
    nodeDeleted   = QtCore.Signal(object)
    node_class    = 'edge'
    """
...
class Connection(QtWidgets.QGraphicsObject):
    
    Type                = QtWidgets.QGraphicsObject.UserType + 4
    ...
    def __init__(self, parent, conn_node, name, **kwargs):
        ...
        self.setFlags(QtWidgets.QGraphicsObject.ItemIsSelectable | QtWidgets.QGraphicsItem.ItemIsFocusable)
...
class DotWidget(QtWidgets.QGraphicsObject): 
        ...
        for conn_name in self.connections:
            ...
            if conn_widget.connected_edges():
                ...
                if conn_widget._debug:
                    ...
                    conn_widget.debug_label.setFlag(QtWidgets.QGraphicsItem.ItemIgnoresTransformations)
...
class NoteWidget(QtWidgets.QGraphicsObject): 
...
class NodeLabel(QtWidgets.QGraphicsObject):
    """
    ...
    def __init__(self, parent):
        ...
        self.label.setFlag(QtWidgets.QGraphicsItem.ItemIsFocusable, False)
    ...
    def keyPressEvent(self, event):
        if event.key() == QtCore.Qt.Key_Enter or event.key() == QtCore.Qt.Key_Return:
            ...
            QtWidgets.QGraphicsObject.keyPressEvent(self, event)
...
class NodeBackground(QtWidgets.QGraphicsItem):
...
class NodeText(QtWidgets.QGraphicsObject):
...
class DotConnection(QtWidgets.QGraphicsObject):
    ...
    def __init__(self, parent, conn_node, name, **kwargs):
        ...
        self.setAcceptHoverEvents(True)
        self.setFlags(QtWidgets.QGraphicsObject.ItemIsSelectable | QtWidgets.QGraphicsItem.ItemIsFocusable | QtWidgets.QGraphicsItem.ItemStacksBehindParent)
        self.setFlag(QtWidgets.QGraphicsObject.ItemSendsGeometryChanges, True)
        self.setFlag(QtWidgets.QGraphicsObject.ItemSendsScenePositionChanges, True)
    ...
    def itemChange(self, change, value):
        ...
        """
        #print('change: ', change
        if change == QtWidgets.QGraphicsItem.ItemPositionHasChanged or change == QtWidgets.QGraphicsItem.ItemTransformChange or change == QtWidgets.QGraphicsItem.ItemTransformChange:
            self._rotated = False
...
class NoteBackground(QtWidgets.QGraphicsObject):
