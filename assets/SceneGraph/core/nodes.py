...
from damgteam.core import log, Attribute, EventHandler, MetadataParser
from options import SCENEGRAPH_CORE, SCENEGRAPH_PLUGIN_PATH, SCENEGRAPH_METADATA_PATH
import util
        ...
        for cls in reversed(result):
            ...
            for section in parsed:
                ...
                for attr in attributes:
                    ...
                    node_metadata.get(section).get(attr).initialize(attr_properties)
