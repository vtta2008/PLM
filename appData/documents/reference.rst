...
This is the list of plugins/scripts that I am referencing.
...
.. code:: bash
    ...
    Contributor Code of Conduct — PyPA documentation. (n.d.).
    Retrieved from https://www.pypa.io/en/latest/code-of-conduct/

    zfec. (n.d.). Retrieved from https://tahoe-lafs.org/trac/zfec