...
SPECS = dict(about         = {'ordinal': 'u01', 'objName': 'About',          'type': PLM_TYPES['info'],    'lvl': UI_LVL['nd'], 'title': 'About'              , 'id': 'PAB', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             ...
             codeConduct   = {'ordinal': 'u01', 'objName': 'CodeConduct',    'type': PLM_TYPES['info'],    'lvl': UI_LVL['nd'], 'title': 'Code of Conduct'    , 'id': 'PCC', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             ...
             contributing  = {'ordinal': 'u01', 'objName': 'Contributing',   'type': PLM_TYPES['info'],    'lvl': UI_LVL['nd'], 'title': 'Contributing'       , 'id': 'PCB', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             ...
             licenceMIT    = {'ordinal': 'u01', 'objName': 'LicenceMIT',     'type': PLM_TYPES['info'],    'lvl': UI_LVL['nd'], 'title': 'Licence'            , 'id': 'MIT', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             ...
             quickSetting  = {'ordinal': 'u37', 'objName': 'QuickSetting',   'type': PLM_TYPES['setting'], 'lvl': UI_LVL['nd'], 'title': None                 , 'id': 'PGS', 'tag': None                 , 'flag': None              , 'cls': QGridLayout, },
             reference     = {'ordinal': 'u01', 'objName': 'Reference',      'type': PLM_TYPES['info'],    'lvl': UI_LVL['nd'], 'title': 'Reference'          , 'id': 'PRF', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             screenShot    = {'ordinal': 'u20', 'objName': 'ScreenShot',     'type': PLM_TYPES['layout'],  'lvl': UI_LVL['nd'], 'title': 'Screenshot'         , 'id': 'PSC', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             serverStatus  = {'ordinal': 'u21', 'objName': 'ServerStatus',   'type': PLM_TYPES['net'],     'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'PSS', 'tag': None                 , 'flag': None              , 'cls': QGridLayout, },
             settingUI     = {'ordinal': 'u22', 'objName': 'Setting Manager','type': PLM_TYPES['config'],  'lvl': UI_LVL['nd'], 'title': 'Application Setting', 'id': 'PSM', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             signup        = {'ordinal': 'u23', 'objName': 'SignUp',         'type': PLM_TYPES['layout'],  'lvl': UI_LVL['nd'], 'title': 'Sign Up'            , 'id': 'PLU', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             statusBar     = {'ordinal': 'u24', 'objName': 'SubMenu',        'type': PLM_TYPES['menu'],    'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'PSU', 'tag': None                 , 'flag': None              , 'cls': QMainWindow},
             subMenu       = {'ordinal': 'u25', 'objName': 'SubMenu',        'type': PLM_TYPES['menu'],    'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'PSU', 'tag': None                 , 'flag': None              , 'cls': QMainWindow},
             sysTray       = {'ordinal': 'u26', 'objName': 'SystemTray',     'type': PLM_TYPES['sysTray'], 'lvl': UI_LVL['st'], 'title': None                 , 'id': 'PST', 'tag': None                 , 'flag': None              , 'cls': QSystemTrayIcon, },
             testUI        = {'ordinal': 't01', 'objName': 'TestUI',         'type': PLM_TYPES['testUI'],  'lvl': UI_LVL['nd'], 'title': 'Test Layout'        , 'id': 'PTU', 'tag': 'PLM TEST UI'        , 'flag': 'Test Layout'     , 'cls': QMainWindow, },
             textEditor    = {'ordinal': 'u28', 'objName': 'TextEditor',     'type': PLM_TYPES['layout'],  'lvl': UI_LVL['nd'], 'title': 'Text Editor'        , 'id': 'PTE', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             toolBar       = {'ordinal': 'u29', 'objName': 'ToolBar',        'type': PLM_TYPES['layout'],  'lvl': UI_LVL['nd'], 'title': None                 , 'id': 'PTB', 'tag': None                 , 'flag': None              , 'cls': QMainWindow, },
             topTab        = {'ordinal': 'u30', 'objName': 'TopTab',         'type': PLM_TYPES['tab'],     'lvl': UI_LVL['nd'], 'title': None                 , 'id': 'PTT', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             topTab1       = {'ordinal': 'u31', 'objName': 'TopTab1',        'type': PLM_TYPES['tab'],     'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'TT1', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             topTab2       = {'ordinal': 'u32', 'objName': 'TopTab2',        'type': PLM_TYPES['tab'],     'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'TT2', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             topTab3       = {'ordinal': 'u33', 'objName': 'TopTab3',        'type': PLM_TYPES['tab'],     'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'TT3', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             topTab4       = {'ordinal': 'u34', 'objName': 'TopTab4',        'type': PLM_TYPES['tab'],     'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'TT4', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             topTab5       = {'ordinal': 'u35', 'objName': 'TopTab5',        'type': PLM_TYPES['tab'],     'lvl': UI_LVL['rd'], 'title': None                 , 'id': 'TT5', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             userSetting   = {'ordinal': 'u36', 'objName': 'UserSetting',    'type': PLM_TYPES['layout'],  'lvl': UI_LVL['nd'], 'title': 'User Preference'    , 'id': 'PUS', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             version       = {'ordinal': 'u01', 'objName': 'Version',        'type': PLM_TYPES['info'],    'lvl': UI_LVL['nd'], 'title': 'Version'            , 'id': 'PVS', 'tag': None                 , 'flag': None              , 'cls': QWidget, },
             )
