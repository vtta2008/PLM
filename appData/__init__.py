...
from .configs            import (__plmWiki__, __localServer__, __pkgsReq__, __homepage__, __appname__, __organization__,
                                 ...
                                 TRADE_MARK, PLM_ABOUT, WAIT_FOR_UPDATE, WAIT_TO_COMPLETE, WAIT_LAYOUT_COMPLETE, PASSWORD_FORGOTTON, SIGNUP,
                                 DISALLOW, TIT_BLANK, PW_BLANK, PW_WRONG, PW_UNMATCH, PW_CHANGED, FN_BLANK, LN_BLANK, SEC_BLANK, USER_CHECK_REQUIRED,
                                 USER_NOT_CHECK, USER_BLANK, USER_CHECK_FAIL, USER_NOT_EXSIST, USER_CONDITION, SYSTRAY_UNAVAI, PTH_NOT_EXSIST,
                                 ERROR_OPENFILE, ERROR_QIMAGE, tooltips_present, tooltips_missing, N_MESSAGES_TEXT, SERVER_CONNECT_FAIL,
                                 TEMPLATE_QRC_HEADER, TEMPLATE_QRC_FILE, TEMPLATE_QRC_FOOTER, HEADER_SCSS, HEADER_QSS,

                                 TRACK_TDS, TRACK_VFX, TRACK_ART, TRACK_PRE, TRACK_TEX, TRACK_POST, TRACK_OFFICE, TRACK_DEV, TRACK_TOOLS,
                                 TRACK_EXTRA, TRACK_SYSTRAY, KEYDETECT, FIX_KEY, CONFIG_APPUI, KEYPACKAGE, CONFIG_TDS, CONFIG_VFX, CONFIG_ART,
                                 CONFIG_PRE, CONFIG_TEX, CONFIG_POST, CONFIG_OFFICE, CONFIG_DEV, CONFIG_TOOLS, CONFIG_EXTRA, CONFIG_SYSTRAY,
                                 ACTIONS_DATA, SHOWLAYOUT_KEY, RESTORE_KEY, SHOWMAX_KEY, SHOWMIN_KEY, STYLESHEET_KEY, OPEN_BROWSER_KEY, START_FILE,
                                 EDIT_KEY, START_FILE_KEY, EXECUTING_KEY, IGNORE_ICON_NAME, QT_BINDINGS, QT_ABSTRACTIONS, QT5_IMPORT_API,
                                 QT_API_VALUES, QT_LIB_VALUES, QT_BINDING, QT_ABSTRACTION, IMAGE_BLACKLIST, PY2, SYS_OPTS, notKeys,
                                 ...
                                 SiPoExp, SiPoIgn, SiPoMax, SiPoMin, SiPoPre, right, left, center, StateMax, StateMin, StateNormal, dockB, dockL,
                                 dockR, dockT, DarkPalette, PRS, FRAMELESS, KEY_RETURN, SCROLLBAROFF, NO_WRAP, BTNTAGSIZE, TAGBTNSIZE, BTNICONSIZE,
                                 ICONBTNSIZE, KEY_RELEASE,
