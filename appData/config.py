...
allDirs = [APP_DATA_DIR, APP_ICON_DIR, AVATAR_DIR, BIN_DIR, BODY_DIR, BUILD_DIR, CACHE_DIR, CFG_DIR, CONFIG_DAMG_DIR,
           CONFIG_PLM_DIR, CORES_DIR, CORE_DIR, DAMG_LOGO_DIR, DATA_DIR, DB_DIR, DEPENDANCIES_DIR, DESKTOP_DIR,
           DOCUMENTATION_DIR, FOOTER_DIR, FUNCS_DIR, GUI_DIR, HEADER_DIR, HOOK_DIR, HOUDINI_DIR, ICON_DIR_16,
           ICON_DIR_24, ICON_DIR_32, ICON_DIR_48, ICON_DIR_64, IMG_DIR, INFO_DIR, JSON_DIR, LOCALAPPDATA, LOGO_DIR,
           LOG_DIR, MARI_DIR, MAYA_DIR, MAYA_ICON_DIR, MENU_DIR, NETWORK_DIR, NODEGRAPH_DIR, NODE_GRAPH_DIR, NUKE_DIR,
           ORG_DIR, PIC_DIR, PLM_LOGO_DIR, PLUGIN_DIR, PREF_DIR, PRJ_DIR, PROGRAM64, PROGRAM86, PROGRAMDATA, PROJECT_DIR,
           QSS_DIR, RAWS_DATA_DIR, RCS_DIR, RESOURCES_DIR, ROOT_DIR, SCRIPTS_DIR, SETTINGS_DIR, SETTING_DIR, SOUND_DIR,
           SUBUI_DIR, TABS_DIR, TAG_DIR, TASK_DIR, TEAM_DIR, TEST_DIR, TMP_DIR, TOOLBAR_DIR, TOOLKIT_DIR, TOOLS_DIR,
           UI_BASE_DIR, UI_DIR, USER_PREF_DIR, UTILS_DIR, WEB_ICON_128, WEB_ICON_16, WEB_ICON_24, WEB_ICON_32,
           WEB_ICON_48, WEB_ICON_64, WEB_ICON_DIR, WIDGETS_DIR, ZBRUSH_DIR]
