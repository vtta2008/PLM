...
allDirs = [APP_DATA_DIR, APP_ICON_DIR, AVATAR_DIR, BIN_DIR, BODY_DIR, BUILD_DIR, CACHE_DIR, CFG_DIR, CONFIG_DAMG_DIR,
           ...
           LOG_DIR, MARI_DIR, MAYA_DIR, MAYA_ICON_DIR, NODEGRAPH_DIR, NODE_GRAPH_DIR, NUKE_DIR,
           ...
           SUBUI_DIR, TABS_DIR, TAG_DIR, TASK_DIR, TEAM_DIR, TEST_DIR, TMP_DIR, TOOLKIT_DIR, TOOLS_DIR,
