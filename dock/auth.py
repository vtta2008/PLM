...
from dock import constants
from dock import errors, utils
...
class BuildApiMixin(object):
    ...
    def build(self, path            = None , tag         = None, quiet              = False, fileobj        = None, timeout = None,
                    custom_context  = False, encoding    = None, pull               = False, nocache        = False,
                    forcerm         = False, dockerfile  = None, container_limits   = None,  rm             = False,
        ...
        response = self._post(u, data=context, params=params, headers=headers, stream=True, timeout=timeout, )
