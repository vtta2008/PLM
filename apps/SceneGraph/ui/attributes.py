...
import util
from core import log, MetadataParser
from options import SCENEGRAPH_STYLESHEET_PATH, PLATFORM
...
class AttributeEditor(QtWidgets.QWidget):
    ...
    def nodeAttributeChanged(self, editor):
        ...
        :param QtWidgets.QWidget editor: node editor widget.
...
class AddAttributeDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, nodes=[]):
        ...
        self.checkbox_connectable = QtWidgets.QCheckBox(self.groupBox)
...
class QFloatEditor(QtWidgets.QWidget):
...
class QIntEditor(QtWidgets.QWidget):
...
class QFloat2Editor(QtWidgets.QWidget):
...
class QFloat3Editor(QtWidgets.QWidget):
...
class QInt2Editor(QtWidgets.QWidget):
...
class QInt3Editor(QtWidgets.QWidget):
...
class QBoolEditor(QtWidgets.QCheckBox):
...
class StringEditor(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        # value 1 editor
        self.val1_edit = QtWidgets.QLineEdit(self)
...
class DocumentEditor(QtWidgets.QWidget):
...
class FileEditor(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.button_browse = QtWidgets.QToolButton(self)
...
class ColorSwatch(QtWidgets.QToolButton):
...
class QFloatLineEdit(QtWidgets.QLineEdit):
    ...
    def update(self):
        ...
        super(QFloatLineEdit, self).initialize()
...
class QIntLineEdit(QtWidgets.QLineEdit):
    ...
    def update(self):
        if self.text():
            self.setText(self.text())        
        super(QIntLineEdit, self).initialize()
