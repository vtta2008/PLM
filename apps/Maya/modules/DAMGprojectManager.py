...
class DAMGprojectManagerUI(object):
    def __init__(self):
        ...
        cmds.text(l="", h=2)
        cmds.text(l="Project Mode", w=200, align='center')
    ...
    def newprojectUI_groupMode(self, *args):
        ...
        #3rd layer
        lo1_rll_rl1 = cmds.rowColumnLayout(nc=2, cat=[1, "both", 1], cw=([1,150],[2,450]))
        makeAcoolButton('Set project Path', self.browseDir, 75)
        global saveprojectPath
        saveprojectPath = ""
        projectPth = cmds.textField('projectPth', text=saveprojectPath)
        ...
        lo1_rll_rl1_lo1 = cmds.columnLayout()
        cmds.text(l="Character name", w=120, h=20, align='center')
        #list of folders in pre project folders /5th layer
        lo1_rll_rl1_lo1_cn1 = cmds.columnLayout(h=260)
        global charName1, charName2, charName3, charName4, charName5
        global charName6, charName7, charName8, charName9, charName10
        global charName11, charName12, charName13
        charName1 = cmds.textField("charName1", text='clam shell', w=120)
        charName2 = cmds.textField("charName2", text='tongue', w=120)
        charName3 = cmds.textField("charName3", text='stonefish', w=120)
        charName4 = cmds.textField("charName4", text='', w=120)
        charName5 = cmds.textField("charName5", text='', w=120)
        charName6 = cmds.textField("charName6", text='', w=120)
        charName7 = cmds.textField("charName7", text='', w=120)
        charName8 = cmds.textField("charName8", text='', w=120)
        charName9 = cmds.textField("charName9", text='', w=120)
        charName10 = cmds.textField("charName10", text='', w=120)
        charName11 = cmds.textField("charName11", text='', w=120)
        charName12 = cmds.textField("charName12", text='', w=120)
        charName13 = cmds.textField("charName13", text='', w=120)
        
        #come back to 3rd layer
        cmds.setParent(lo1_rll_rl1)
        #environment objects row
        lo1_rll_rl1_lo2 = cmds.columnLayout()
        cmds.text(l="Env.Objs name", w=120, h=20, align='center')
        lo1_rll_rl1_lo2_eo1 = cmds.columnLayout(h=260)
        global envObj1, envObj2, envObj3, envObj4, envObj5, envObj6
        global envObj7, envObj8, envObj9, envObj10, envObj11, envObj12, envObj13
        envObj1 = cmds.textField("envObj1", text='table coral', w=120)
        envObj2 = cmds.textField("envObj2", text='staghorn coral', w=120)
        envObj3 = cmds.textField("envObj3", text='star fish', w=120)
        envObj4 = cmds.textField("envObj4", text='', w=120)
        envObj5 = cmds.textField("envObj5", text='', w=120)
        envObj6 = cmds.textField("envObj6", text='', w=120)
        envObj7 = cmds.textField("envObj7", text='', w=120)
        envObj8 = cmds.textField("envObj8", text='', w=120)
        envObj9 = cmds.textField("envObj9", text='', w=120)
        envObj10 = cmds.textField("envObj10", text='', w=120)
        envObj11 = cmds.textField("envObj11", text='', w=120)
        envObj12 = cmds.textField("envObj12", text='', w=120)
        envObj13 = cmds.textField("envObj13", text='', w=120)
        #come back to 3rd layer
        cmds.setParent(lo1_rll_rl1)
        #props objects row
        lo1_rll_rl1_lo3 = cmds.columnLayout()
        cmds.text(l="Props name", w=120, h=20, align='center')
        pl1_rll_rl1_lo3_pn1 = cmds.columnLayout(h=260)
        global prop1, prop2, prop3, prop4, prop5, prop6
        global prop7, prop8, prop9, prop10, prop11, prop12, prop13
        prop1 = cmds.textField("prop1", text='sand', w=120)
        prop2 = cmds.textField("prop2", text='rock', w=120)
        prop3 = cmds.textField("prop3", text='', w=120)
        prop4 = cmds.textField("prop4", text='', w=120)
        prop5 = cmds.textField("prop5", text='', w=120)
        prop6 = cmds.textField("prop6", text='', w=120)
        prop7 = cmds.textField("prop7", text='', w=120)
        prop8 = cmds.textField("prop8", text='', w=120)
        prop9 = cmds.textField("prop9", text='', w=120)
        prop10 = cmds.textField("prop10", text='', w=120)
        prop11 = cmds.textField("prop11", text='', w=120)
        prop12 = cmds.textField("prop12", text='', w=120)
        prop13 = cmds.textField("prop13", text='', w=120)
        #come back to 3rd layer
        cmds.setParent(lo1_rll_rl1)
        ...
        lo1_rll_rl1_lo4_rc1 = cmds.rowColumnLayout(nc=2, cat=[1, "both", 1], cw=([1,120],[2,120]))
        global prjFullName
        cmds.text(l="Full name of Project", w=120, h=20, align='center')
        prjFullName = cmds.textField("prjFullName", text="deep_sea")
        global prjShortName
        cmds.text(l="Project Short Name", w=120, h=20, align='center')
        prjShortName = cmds.textField("prjShortName", text='CLM')
        global numOfShots
        cmds.text(l="Number of shots", w=120, h=20, align='center')
        numOfShots = cmds.intField("numOfShots", v=20)
        global numOfChars
        cmds.text(l="Number of Characters", w=120, h=20, align='center')
        numOfChars = cmds.intField("numOfChars", v=3)
        global numOfenvObj
        cmds.text(l="Objects in evironment", w=120, align='center')
        numOfenvObj = cmds.intField("numOfenvObj", v=3)
        global numOfProps
        cmds.text(l="Number of Props", w=120, align='center')
        numOfProps = cmds.intField("numOfProps", v=2)
        
        #come back to 4th layer
        cmds.setParent(lo1_rll_rl1_lo4)
        lo1_rll_rl1_lo4_rc2 = cmds.rowColumnLayout(nc=3, cat=[1, "both", 1], cw=[(1,5),(2,230),(3,5)])
        cmds.text(l="")
        makeAcoolButton('Create project folder structure', self.createFolderStructure, 225)
        cmds.text(l="")
        cmds.setParent('..')
        
        lo1_rll_rl1_lo4_rc2 = cmds.rowColumnLayout(nc=4, cat=[1, "both", 1], cw = [(1,5),(2,115),(3,115),(4,5)])
        cmds.text(l="")
        makeAcoolButton('Set Project', self.setProj, 110)
        makeAcoolButton('Create Maya Folder', self.mayaFolder, 110)
        cmds.text(l="")
        #come back to tab1 layer
        cmds.setParent(tab1)
        cmds.showWindow(JTpmWinID)
