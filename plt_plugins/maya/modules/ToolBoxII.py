...
# IMPORT QT MODULES
# -------------------------------------------------------------------------------------------------------------
from plt_plugins.maya.plugins import Qt  # plugin module go with DAMGtool to make UI
...
if Qt.__binding__ == 'PySide':
    ...
    from plt_plugins.maya.plugins.Qt.QtCore import Signal
elif Qt.__binding__.startswith('PyQt'):
    logger.debug('Using PyQt with sip')
    from sip import wrapinstance as wrapInstance
    from plt_plugins.maya.plugins.Qt.QtCore import pyqtSignal as Signal
else:
