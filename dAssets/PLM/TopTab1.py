...
from dCore.Metadata import __envKey__
# Plt
from dCore.keys import CONFIG_TOOLS, CONFIG_DEV, CONFIG_EXTRA, CONFIG_OFFICE
from dCore.paths import BTNICONSIZE, ICONBTNSIZE, FIX_KEYS
