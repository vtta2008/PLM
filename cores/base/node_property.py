...
from toolkits.Widgets import GroupBox, VBoxLayout, ComboBox, LineEdit, CheckBox
...
class NodeComboBox(NodeBaseWidget):
    ...
    def value(self, text=''):
        if text != self.value:
            index = self._combo.findText(text, Qt.MatchExactly)
...
class NodeLineEdit(NodeBaseWidget):
    ...
    def __init__(self, parent=None, name='', label='', text=''):
        ...
        self._ledit.setAlignment(Qt.AlignCenter)
...
# -------------------------------------------------------------------------------------------------------------
# Created by panda on 4/12/2019 - 2:21 AM
