...
__damgSlogan__      = "Comprehensive Solution"
__website__         = "http://damgteam.com"
...
__serverGlobal__        = "https://pipeline.damgteam.com"
__serverCheck__         = "https://pipeline.damgteam.com/check"
__serverAutho__         = "https://pipeline.damgteam.com/auth"

__serverLocal__         = "http://localhost:20987"
__serverLocalCheck__    = "http://localhost:20987/check"
__serverLocalAutho__    = "http://localhost:20987/auth"
...
COPYRIGHT               = "{0} software (c) 2017-2019 {1}. All rights reserved.".format(__appname__, __organization__)
PLUGINVERSION           = "{0}.13.configuration.{1}".format(__appname__, __cfgVersion__)
